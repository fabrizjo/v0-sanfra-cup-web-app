...
export default function CalcioJuniorPage() {
  ...
  const whatsappMessage = encodeURIComponent("Ciao, desidero avere più informazioni riguardo Sanfra Cup Calcio Junior")
    ...
    <div className="min-h-screen bg-black">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            <span className="text-white">Calcio</span>{' '}<span className="text-yellow-400">Junior</span>
          </motion.h1>
          ...
          >
            Il torneo di calcio a 6 dedicato ai piu giovani. Il futuro del calcio inizia qui!
          </motion.p>
