      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <motion.p
            ...
            className="text-2xl md:text-3xl text-yellow-400 font-spacema mb-8"
          >
            Torneo di pallavolo misto
          </motion.p>
          ...
          >
            Partecipa al torneo di pallavolo della Sanfra Cup. Divertimento e competizione ti aspettano!
          </motion.p>
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
              <div className="bg-neutral-900 border border-yellow-500/20 rounded-2xl p-6">
                ...
                <p className="text-white text-xl font-semibold">Misto</p>
              </div>
              <div className="bg-neutral-900 border border-yellow-500/20 rounded-2xl p-6">
