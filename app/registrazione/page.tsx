  ...
  return (
    <div className="min-h-screen bg-black relative">
      ...
      <div className="fixed inset-0 z-0 opacity-5">
        <Image src="/images/sanfra-logo.png" alt="Sanfra Cup Logo" fill className="object-contain" />
      </div>
        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-300">
              Compila il modulo sottostante per iscrivere la tua squadra al torneo di {sportLabel.toLowerCase()} della Sanfra Cup
            </p>
          </div>
