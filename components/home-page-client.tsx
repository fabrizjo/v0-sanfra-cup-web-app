...
<li><button type="button" onClick={() => { window.scrollTo({ top: 0, behavior: "smooth" }); handleSportChange("home"); }} className="text-gray-500 hover:text-yellow-400 text-sm transition-colors">Home</button></li>
