    ...
    <div className={`relative inline-block ${className}`} ref={popoverRef}>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="bg-zinc-900 border border-yellow-500/20 rounded-xl p-4 shadow-2xl shadow-black/50 min-w-[220px]">
              <a
                href={WHATSAPP_URL}
                target="_blank"
              ...
              >
                <div className="flex-shrink-0 h-10 w-10 bg-[#25D366] rounded-full flex items-center justify-center">
            ...
            {/* Arrow */}
            <div className="absolute left-1/2 -translate-x-1/2 -bottom-1.5 w-3 h-3 rotate-45 bg-zinc-900 border-r border-b border-yellow-500/20" />
          </motion.div>
        )}
      </AnimatePresence>
    </div>
